...
<?php
  for ($i=0; $i < $limit; $i++) { 
     echo "[' <h1>".$myArrayb[$i][8]."</h1><br><h3>Última conexión: ".$myArrayb[$i][1]."</h3><br>Barrio: ".$myArrayb[$i][4]."<br>Alimentador: ".$myArrayb[$i][7]."<br>Potencia Nominal: ".$myArrayb[$i][6]."<br>Location: ".$myArray[$i][0]."  ', ".$myArray[$i][0]."],";
   } 
  ?>
